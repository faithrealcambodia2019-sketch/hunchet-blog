...
// Tight head crop of the portrait, resized on WordPress's image CDN so the
// face is still readable at 16–32px in a browser tab.
const FACE_CROP = "crop=24,4,52,52";
export const FAVICON = `${LOGO}?${FACE_CROP}&resize=64,64`;
export const APPLE_ICON = `${LOGO}?${FACE_CROP}&resize=180,180`;
