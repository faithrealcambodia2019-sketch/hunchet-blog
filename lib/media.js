...
// Full portrait (head to shoulders, uncropped), resized on WordPress's image
// CDN so the browser only downloads a small icon-sized file.
export const FAVICON = `${LOGO}?w=64`;
export const APPLE_ICON = `${LOGO}?w=180`;
